...
import { getMatch, getSeasonMatches, postMatch, postMatchComment, postPlayerRating, postPlayerVote, putMatch, removeMatch } from '../controllers/matchController';
import { adminMiddleware, authMiddleware } from '../middleware/authMiddleware';
import { validateBody } from '../middleware/validationMiddleware';
import { matchCommentSchema, matchSchema, playerRatingSchema, playerVoteSchema } from '../validation/schemas';
...
matchRoutes.post('/matches/:id/comments', validateBody(matchCommentSchema), postMatchComment);
