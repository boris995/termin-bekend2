...
import { createSeason, deleteSeason, exportSeasonReport, getActiveSeason, getSeason, getSeasons, updateSeason } from '../controllers/seasonController';
...
seasonRoutes.get('/:id/export.html', exportSeasonReport);
